...
class LogicalRouterState(object):
    ...
    def __init__(self, state=None, details=None, failure_code=None, failure_message=None, *args, **kwargs):  # noqa: E501
        """LogicalRouterState - a model defined in Swagger"""  # noqa: E501
        self._state = None
        self._details = None
    ...
    @property
    def state(self):
        """Gets the state of this LogicalRouterState.  # noqa: E501
        ...
        :return: The state of this LogicalRouterState.  # noqa: E501
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this LogicalRouterState.

        Gives details of state of desired configuration. Additional enums with more details on progress/success/error states are sent for edge node. The success states are NODE_READY and TRANSPORT_NODE_READY, pending states are {VM_DEPLOYMENT_QUEUED, VM_DEPLOYMENT_IN_PROGRESS, REGISTRATION_PENDING} and other values indicate failures. \"in_sync\" state indicates that the desired configuration has been received by the host to which it applies, but is not yet in effect. When the configuration is actually in effect, the state will change to \"success\". Please note, failed state is deprecated.   # noqa: E501

        :param state: The state of this LogicalRouterState.  # noqa: E501
        :type: str
        """
    ...
    @property
    def details(self):
        """Gets the details of this LogicalRouterState.  # noqa: E501

        Array of configuration state of various sub systems  # noqa: E501

        :return: The details of this LogicalRouterState.  # noqa: E501
    ...
    def details(self, details):
        """Sets the details of this LogicalRouterState.

        Array of configuration state of various sub systems  # noqa: E501

        :param details: The details of this LogicalRouterState.  # noqa: E501
    ...
    def failure_code(self):
        """Gets the failure_code of this LogicalRouterState.  # noqa: E501

        Error code  # noqa: E501

        :return: The failure_code of this LogicalRouterState.  # noqa: E501
        :rtype: int
        """
    ...
    def failure_code(self, failure_code):
        """Sets the failure_code of this LogicalRouterState.

        Error code  # noqa: E501

        :param failure_code: The failure_code of this LogicalRouterState.  # noqa: E501
        :type: int
        """
    ...
    def failure_message(self):
        """Gets the failure_message of this LogicalRouterState.  # noqa: E501

        Error message in case of failure  # noqa: E501

        :return: The failure_message of this LogicalRouterState.  # noqa: E501
        :rtype: str
        """
    ...
    def failure_message(self, failure_message):
        """Sets the failure_message of this LogicalRouterState.

        Error message in case of failure  # noqa: E501

        :param failure_message: The failure_message of this LogicalRouterState.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LogicalRouterState, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LogicalRouterState):
            return False
