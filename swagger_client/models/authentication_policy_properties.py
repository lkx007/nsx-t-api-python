...
class AuthenticationPolicyProperties(object):
    ...
    def __init__(self, _self=None, links=None, schema=None, api_failed_auth_reset_period=900, minimum_password_length=8, cli_failed_auth_lockout_period=900, api_max_auth_failures=5, api_failed_auth_lockout_period=900, cli_max_auth_failures=5, *args, **kwargs):  # noqa: E501
