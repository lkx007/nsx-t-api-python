...
class VirtualMachine(object):
    ...
    def __init__(self, last_sync_time=None, display_name=None, description=None, resource_type=None, tags=None, source=None, local_id_on_host=None, type=None, guest_info=None, power_state=None, compute_ids=None, host_id=None, external_id=None, *args, **kwargs):  # noqa: E501
