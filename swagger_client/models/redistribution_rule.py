...
class RedistributionRule(object):
    ...
    def __init__(self, sources=None, route_map_id=None, description=None, display_name=None, destination=None, address_family='IPV4_AND_IPV6'):  # noqa: E501
