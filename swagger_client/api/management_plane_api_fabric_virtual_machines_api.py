...
class ManagementPlaneApiFabricVirtualMachinesApi(object):
    ...
    def list_virtual_machines(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.list_virtual_machines(async_req=True)
        >>> result = thread.get()
    ...
    def list_virtual_machines_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_virtual_machines_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def list_vm_tools_info(self, **kwargs):  # noqa: E501
        """Return the list of tools and agents installed in VMs.  # noqa: E501

        This API returns the list of tools and agents installed in VMs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_vm_tools_info(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_vm_tools_info_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_vm_tools_info_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_vm_tools_info_with_http_info(self, **kwargs):  # noqa: E501
        """Return the list of tools and agents installed in VMs.  # noqa: E501

        This API returns the list of tools and agents installed in VMs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_vm_tools_info_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_vm_tools_info" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/fabric/virtual-machines/tools-info', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='VmToolsInfoListResult',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_virtual_machine_tags_update_tags(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_virtual_machine_tags_update_tags(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param VirtualMachineTagUpdate body: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_virtual_machine_tags_update_tags_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_virtual_machine_tags_update_tags_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def update_virtual_machine_tags_update_tags_with_http_info(self, body, **kwargs):  # noqa: E501
        """Update tags applied to a virtual machine  # noqa: E501

        Update tags applied to the virtual machine. External id of the virtual machine will be specified in the request body. Request body should contain all the tags to be applied. To clear all tags, provide an empty list. User can apply maximum 25 tags on a virtual machine. The remaining 5 are reserved for system defined tags.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_virtual_machine_tags_update_tags_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_virtual_machine_tags_update_tags`")  # noqa: E501
