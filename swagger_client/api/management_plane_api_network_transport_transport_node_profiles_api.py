...
class ManagementPlaneApiNetworkTransportTransportNodeProfilesApi(object):
    ...
    def update_transport_node_profile_with_http_info(self, body, transport_node_profile_id, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'transport_node_profile_id', 'esx_mgmt_if_migration_dest', 'if_id', 'ping_ip', 'vnic', 'vnic_migration_dest']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
