...
class ManagementPlaneApiUpgradeHistoryApi(object):
    ...
    def get_upgrade_history(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_upgrade_history(async_req=True)
        >>> result = thread.get()
    ...
    def get_upgrade_history_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_upgrade_history_with_http_info(async_req=True)
        >>> result = thread.get()
