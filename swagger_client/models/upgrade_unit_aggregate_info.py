...
class UpgradeUnitAggregateInfo(object):
    ...
    def __init__(self, _self=None, links=None, schema=None, status=None, pre_upgrade_checks=None, errors=None, display_name=None, post_upgrade_checks=None, warnings=None, current_version=None, group=None, percent_complete=None, type=None, id=None, metadata=None, *args, **kwargs):  # noqa: E501
