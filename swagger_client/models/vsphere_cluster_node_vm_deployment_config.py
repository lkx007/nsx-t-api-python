...
class VsphereClusterNodeVMDeploymentConfig(object):
    ...
    def __init__(self, placement_type=None, dns_servers=None, search_domains=None, management_network_id=None, enable_ssh=False, allow_ssh_root_login=False, compute_id=None, ntp_servers=None, vc_id=None, storage_id=None, default_gateway_addresses=None, management_port_subnets=None, host_id=None, hostname=None, *args, **kwargs):  # noqa: E501
    ...
    def placement_type(self):
        """Gets the placement_type of this VsphereClusterNodeVMDeploymentConfig.  # noqa: E501

        Specifies the config for the platform through which to deploy the VM   # noqa: E501

        :return: The placement_type of this VsphereClusterNodeVMDeploymentConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def placement_type(self, placement_type):
        """Sets the placement_type of this VsphereClusterNodeVMDeploymentConfig.

        Specifies the config for the platform through which to deploy the VM   # noqa: E501

        :param placement_type: The placement_type of this VsphereClusterNodeVMDeploymentConfig.  # noqa: E501
        :type: str
        """
        if placement_type is None:
            raise ValueError("Invalid value for `placement_type`, must not be `None`")  # noqa: E501
        allowed_values = ["VsphereClusterNodeVMDeploymentConfig"]  # noqa: E501
