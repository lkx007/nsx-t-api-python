...
class BgpNeighborStatus(object):
    ...
    def __init__(self, connection_state=None, keep_alive_interval=None, neighbor_router_id=None, total_out_prefix_count=None, lr_component_id=None, established_connection_count=None, messages_sent=None, time_since_established=None, hold_time=None, graceful_restart=None, graceful_restart_mode=None, connection_drop_count=None, remote_port=None, total_in_prefix_count=None, messages_received=None, transport_node=None, local_port=None, remote_as_number=None, announced_capabilities=None, negotiated_capability=None, address_families=None, source_address=None, neighbor_address=None):  # noqa: E501
