...
class NodeInterfaceStatisticsProperties(object):
    ...
    def __init__(self, _self=None, links=None, schema=None, tx_dropped=None, rx_packets=None, tx_carrier=None, rx_bytes=None, tx_errors=None, interface_id=None, tx_colls=None, rx_frame=None, rx_errors=None, tx_bytes=None, rx_dropped=None, tx_packets=None, source=None, *args, **kwargs):  # noqa: E501
