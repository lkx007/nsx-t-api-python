...
class LbHttpSslCondition(object):
    ...
    def __init__(self, inverse=False, type=None, client_supported_ssl_ciphers=None, client_certificate_issuer_dn=None, client_certificate_subject_dn=None, used_ssl_cipher=None, session_reused='IGNORE', used_protocol=None, *args, **kwargs):  # noqa: E501
    ...
    @property
    def inverse(self):
        """Gets the inverse of this LbHttpSslCondition.  # noqa: E501

        A flag to indicate whether reverse the match result of this condition  # noqa: E501

        :return: The inverse of this LbHttpSslCondition.  # noqa: E501
        :rtype: bool
        """
    ...
    def inverse(self, inverse):
        """Sets the inverse of this LbHttpSslCondition.

        A flag to indicate whether reverse the match result of this condition  # noqa: E501

        :param inverse: The inverse of this LbHttpSslCondition.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def type(self):
        """Gets the type of this LbHttpSslCondition.  # noqa: E501

        Type of load balancer rule condition  # noqa: E501

        :return: The type of this LbHttpSslCondition.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this LbHttpSslCondition.

        Type of load balancer rule condition  # noqa: E501

        :param type: The type of this LbHttpSslCondition.  # noqa: E501
        :type: str
        """
        if type is None:
