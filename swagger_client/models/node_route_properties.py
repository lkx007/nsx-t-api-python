...
class NodeRouteProperties(object):
    ...
    def __init__(self, _self=None, links=None, schema=None, src=None, from_address=None, proto='boot', route_type=None, metric=None, destination=None, interface_id=None, route_id=None, netmask=None, scope=None, gateway=None, *args, **kwargs):  # noqa: E501
