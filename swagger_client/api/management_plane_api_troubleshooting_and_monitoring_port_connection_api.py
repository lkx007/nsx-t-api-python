...
class ManagementPlaneApiTroubleshootingAndMonitoringPortConnectionApi(object):
    ...
    def get_forwarding_path(self, lport_id, peer_port_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_forwarding_path(lport_id, peer_port_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_forwarding_path_with_http_info(self, lport_id, peer_port_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_forwarding_path_with_http_info(lport_id, peer_port_id, async_req=True)
        >>> result = thread.get()
