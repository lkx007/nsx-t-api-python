...
class ManagementPlaneApiGroupingObjectsNsServicesApi(object):
    ...
    def create_ns_service(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_ns_service(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.create_ns_service_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_ns_service_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_ns_service_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create NSService  # noqa: E501

        Creates a new NSService which allows users to specify characteristics to use for matching network traffic.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_ns_service_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_ns_service`")  # noqa: E501
