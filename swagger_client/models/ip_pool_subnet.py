...
class IpPoolSubnet(object):
    ...
    def __init__(self, _self=None, links=None, schema=None, dns_nameservers=None, cidr=None, gateway_ip=None, allocation_ranges=None, dns_suffix=None, *args, **kwargs):  # noqa: E501
