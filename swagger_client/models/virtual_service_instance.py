...
class VirtualServiceInstance(object):
    ...
    def __init__(self, on_failure_policy=None, transport_type=None, resource_type=None, service_id=None, *args, **kwargs):  # noqa: E501
        """VirtualServiceInstance - a model defined in Swagger"""  # noqa: E501
    ...
    def on_failure_policy(self):
        """Gets the on_failure_policy of this VirtualServiceInstance.  # noqa: E501
        ...
        :return: The on_failure_policy of this VirtualServiceInstance.  # noqa: E501
        :rtype: str
        """
    ...
    def on_failure_policy(self, on_failure_policy):
        """Sets the on_failure_policy of this VirtualServiceInstance.

        Failure policy of the service instance - if it has to be different from the service. By default the service instance inherits the FailurePolicy of the service it belongs to.  # noqa: E501

        :param on_failure_policy: The on_failure_policy of this VirtualServiceInstance.  # noqa: E501
        :type: str
        """
    ...
    def transport_type(self):
        """Gets the transport_type of this VirtualServiceInstance.  # noqa: E501
        ...
        :return: The transport_type of this VirtualServiceInstance.  # noqa: E501
        :rtype: str
        """
    ...
    def transport_type(self, transport_type):
        """Sets the transport_type of this VirtualServiceInstance.

        Transport to be used by this service instance for deploying the Service-VM. This field is to be set Not Applicable(NA) if the service only caters to functionality EPP(Endpoint Protection).  # noqa: E501

        :param transport_type: The transport_type of this VirtualServiceInstance.  # noqa: E501
        :type: str
        """
    ...
    def resource_type(self):
        """Gets the resource_type of this VirtualServiceInstance.  # noqa: E501
        ...
        :return: The resource_type of this VirtualServiceInstance.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_type(self, resource_type):
        """Sets the resource_type of this VirtualServiceInstance.

        ServiceInstance is used when NSX handles the lifecyle of   appliance. Deployment and appliance related all the information is necessary. ByodServiceInstance is a custom instance to be used when NSX is not handling   the lifecycles of appliance/s. User will manage their own appliance (BYOD)   to connect with NSX. VirtualServiceInstance is a a custom instance to be used when NSX is not   handling the lifecycle of an appliance and when the user is not bringing   their own appliance.   # noqa: E501

        :param resource_type: The resource_type of this VirtualServiceInstance.  # noqa: E501
        :type: str
        """
    ...
    @property
    def service_id(self):
        """Gets the service_id of this VirtualServiceInstance.  # noqa: E501

        The Service to which the service instance is associated.  # noqa: E501

        :return: The service_id of this VirtualServiceInstance.  # noqa: E501
        :rtype: str
        """
    ...
    def service_id(self, service_id):
        """Sets the service_id of this VirtualServiceInstance.

        The Service to which the service instance is associated.  # noqa: E501

        :param service_id: The service_id of this VirtualServiceInstance.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VirtualServiceInstance, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VirtualServiceInstance):
            return False
