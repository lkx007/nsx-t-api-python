...
class DirectoryDomainSyncStats(object):
    ...
    def prev_sync_type(self):
        ...
        Directory domain previous sync type. It could be one of the following three states. Right after the directory domain is configured, this field is set to IDLE.  # noqa: E501
    ...
    def prev_sync_type(self, prev_sync_type):
        ...
        :type: str
        """
        allowed_values = ["IDLE", "FULL_SYNC", "DELTA_SYNC"]  # noqa: E501
    ...
    def current_state(self):
        ...
        Current running state of the directory domain in synchronization life cycle. It could be one of the following three states.  # noqa: E501
