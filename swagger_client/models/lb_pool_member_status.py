...
class LbPoolMemberStatus(object):
    ...
    def status(self, status):
        ...
        allowed_values = ["UP", "DOWN", "DISABLED", "GRACEFUL_DISABLED", "UNUSED"]  # noqa: E501
