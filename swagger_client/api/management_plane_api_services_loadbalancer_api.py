...
class ManagementPlaneApiServicesLoadbalancerApi(object):
    ...
    def create_load_balancer_tcp_profile(self, body, **kwargs):  # noqa: E501
        """Create a load balancer TCP profile  # noqa: E501

        Create a load balancer TCP profile.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_load_balancer_tcp_profile(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param LbTcpProfile body: (required)
        :return: LbTcpProfile
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_load_balancer_tcp_profile_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_load_balancer_tcp_profile_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_load_balancer_tcp_profile_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create a load balancer TCP profile  # noqa: E501

        Create a load balancer TCP profile.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_load_balancer_tcp_profile_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_load_balancer_tcp_profile" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_load_balancer_tcp_profile`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/loadbalancer/tcp-profiles', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LbTcpProfile',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def delete_load_balancer_tcp_profile(self, tcp_profile_id, **kwargs):  # noqa: E501
        """Delete a load balancer TCP profile  # noqa: E501

        Delete a load balancer TCP profile.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_load_balancer_tcp_profile(tcp_profile_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str tcp_profile_id: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_load_balancer_tcp_profile_with_http_info(tcp_profile_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_load_balancer_tcp_profile_with_http_info(tcp_profile_id, **kwargs)  # noqa: E501
            return data

    def delete_load_balancer_tcp_profile_with_http_info(self, tcp_profile_id, **kwargs):  # noqa: E501
        """Delete a load balancer TCP profile  # noqa: E501

        Delete a load balancer TCP profile.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_load_balancer_tcp_profile_with_http_info(tcp_profile_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['tcp_profile_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_load_balancer_tcp_profile" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'tcp_profile_id' is set
        if ('tcp_profile_id' not in params or
                params['tcp_profile_id'] is None):
            raise ValueError("Missing the required parameter `tcp_profile_id` when calling `delete_load_balancer_tcp_profile`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'tcp_profile_id' in params:
            path_params['tcp-profile-id'] = params['tcp_profile_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/loadbalancer/tcp-profiles/{tcp-profile-id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_load_balancer_tcp_profiles(self, **kwargs):  # noqa: E501
        """Retrieve a paginated list of load balancer TCP profiles  # noqa: E501

        Retrieve a paginated list of load balancer TCP profiles.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_load_balancer_tcp_profiles(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_load_balancer_tcp_profiles_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_load_balancer_tcp_profiles_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_load_balancer_tcp_profiles_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieve a paginated list of load balancer TCP profiles  # noqa: E501

        Retrieve a paginated list of load balancer TCP profiles.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_load_balancer_tcp_profiles_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_load_balancer_tcp_profiles" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LbTcpProfileListResult',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def read_load_balancer_tcp_profile(self, tcp_profile_id, **kwargs):  # noqa: E501
        """Retrieve a load balancer TCP profile  # noqa: E501

        Retrieve a load balancer TCP profile.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_load_balancer_tcp_profile(tcp_profile_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.read_load_balancer_tcp_profile_with_http_info(tcp_profile_id, **kwargs)  # noqa: E501
        else:
            (data) = self.read_load_balancer_tcp_profile_with_http_info(tcp_profile_id, **kwargs)  # noqa: E501
            return data

    def read_load_balancer_tcp_profile_with_http_info(self, tcp_profile_id, **kwargs):  # noqa: E501
        """Retrieve a load balancer TCP profile  # noqa: E501

        Retrieve a load balancer TCP profile.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_load_balancer_tcp_profile_with_http_info(tcp_profile_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method read_load_balancer_tcp_profile" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'tcp_profile_id' is set
        if ('tcp_profile_id' not in params or
                params['tcp_profile_id'] is None):
            raise ValueError("Missing the required parameter `tcp_profile_id` when calling `read_load_balancer_tcp_profile`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/loadbalancer/tcp-profiles/{tcp-profile-id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_load_balancer_tcp_profile(self, body, tcp_profile_id, **kwargs):  # noqa: E501
        """Update a load balancer TCP profile  # noqa: E501

        Update a load balancer TCP profile.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_load_balancer_tcp_profile(body, tcp_profile_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_load_balancer_tcp_profile_with_http_info(body, tcp_profile_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_load_balancer_tcp_profile_with_http_info(body, tcp_profile_id, **kwargs)  # noqa: E501
            return data

    def update_load_balancer_tcp_profile_with_http_info(self, body, tcp_profile_id, **kwargs):  # noqa: E501
        """Update a load balancer TCP profile  # noqa: E501

        Update a load balancer TCP profile.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_load_balancer_tcp_profile_with_http_info(body, tcp_profile_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'tcp_profile_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_load_balancer_tcp_profile" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_load_balancer_tcp_profile`")  # noqa: E501
        # verify the required parameter 'tcp_profile_id' is set
        if ('tcp_profile_id' not in params or
                params['tcp_profile_id'] is None):
            raise ValueError("Missing the required parameter `tcp_profile_id` when calling `update_load_balancer_tcp_profile`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/loadbalancer/tcp-profiles/{tcp-profile-id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
