...
class TunnelProperties(object):
    ...
    def __init__(self, _self=None, links=None, schema=None, status=None, egress_interface=None, remote_node_id=None, bfd=None, local_ip=None, last_updated_time=None, name=None, remote_node_display_name=None, encap=None, latency_type=None, latency_value=None, remote_ip=None, *args, **kwargs):  # noqa: E501
