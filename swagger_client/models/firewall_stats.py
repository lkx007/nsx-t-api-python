...
class FirewallStats(object):
    ...
    def __init__(self, _self=None, links=None, schema=None, total_session_count=None, packet_count=None, popularity_index=None, max_session_count=None, byte_count=None, max_popularity_index=None, hit_count=None, session_count=None, rule_id=None, *args, **kwargs):  # noqa: E501
