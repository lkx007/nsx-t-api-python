...
class NodeNetworkInterfaceProperties(object):
    ...
    def __init__(self, _self=None, links=None, schema=None, physical_address=None, broadcast_address=None, link_status=None, default_gateway=None, bond_primary=None, bond_slaves=None, ip_addresses=None, vlan=None, bond_mode=None, interface_id=None, admin_status=None, plane=None, is_kni=None, ip_configuration=None, mtu=None, *args, **kwargs):  # noqa: E501
