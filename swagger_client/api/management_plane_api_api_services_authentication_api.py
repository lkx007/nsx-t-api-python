...
class ManagementPlaneApiApiServicesAuthenticationApi(object):
    ...
    def read_authentication_policy_properties(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.read_authentication_policy_properties(async_req=True)
        >>> result = thread.get()
    ...
    def read_authentication_policy_properties_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_authentication_policy_properties_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def update_authentication_policy_properties(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_authentication_policy_properties(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AuthenticationPolicyProperties body: (required)
        :return: AuthenticationPolicyProperties
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_authentication_policy_properties_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_authentication_policy_properties_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def update_authentication_policy_properties_with_http_info(self, body, **kwargs):  # noqa: E501
        """Update node authentication policy configuration  # noqa: E501

        Update the currently configured authentication policy on the node. If any of api_max_auth_failures, api_failed_auth_reset_period, or api_failed_auth_lockout_period are modified, the http service is automatically restarted.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_authentication_policy_properties_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_authentication_policy_properties`")  # noqa: E501
