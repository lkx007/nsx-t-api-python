...
class NodeSyslogExporterProperties(object):
    ...
    def __init__(self, _self=None, links=None, schema=None, tls_ca_pem=None, protocol=None, exporter_name=None, level=None, tls_client_ca_pem=None, tls_cert_pem=None, server=None, facilities=None, msgids=None, structured_data=None, port=514, tls_key_pem=None, *args, **kwargs):  # noqa: E501
