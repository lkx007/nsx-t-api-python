...
class FirewallSessionTimerProfile(object):
    ...
    def __init__(self, resource_type=None, tcp_closed=20, tcp_opening=30, udp_single=30, tcp_finwait=45, tcp_first_packet=120, tcp_closing=120, tcp_established=43200, udp_multiple=60, icmp_error_reply=10, udp_first_packet=60, icmp_first_packet=20, *args, **kwargs):  # noqa: E501
    ...
    def resource_type(self):
        """Gets the resource_type of this FirewallSessionTimerProfile.  # noqa: E501

        Resource type to use as profile type  # noqa: E501

        :return: The resource_type of this FirewallSessionTimerProfile.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_type(self, resource_type):
        """Sets the resource_type of this FirewallSessionTimerProfile.

        Resource type to use as profile type  # noqa: E501

        :param resource_type: The resource_type of this FirewallSessionTimerProfile.  # noqa: E501
        :type: str
        """
    ...
    def tcp_closed(self):
        ...
        The timeout value of connection in seconds after one endpoint sends an RST.  # noqa: E501
    ...
    def tcp_opening(self):
        ...
        The timeout value of connection in seconds after a second packet has been transferred.  # noqa: E501
    ...
    def udp_single(self):
        ...
        The timeout value of connection in seconds if the source host sends more than one packet but the destination host has never sent one back.  # noqa: E501
    ...
    def tcp_finwait(self):
        ...
        The timeout value of connection in seconds after both FINs have been exchanged and connection is closed.  # noqa: E501
    ...
    def tcp_first_packet(self):
        ...
        The timeout value of connection in seconds after the first packet has been sent.  # noqa: E501
    ...
    def tcp_closing(self):
        ...
        The timeout value of connection in seconds after the first FIN has been sent.  # noqa: E501
    ...
    def tcp_established(self):
        ...
        The timeout value of connection in seconds once the connection has become fully established.  # noqa: E501
    ...
    def udp_multiple(self):
        ...
        The timeout value of connection in seconds if both hosts have sent packets.  # noqa: E501
    ...
    def icmp_error_reply(self):
        ...
        The timeout value for the connection after an ICMP error came back in response to an ICMP packet.  # noqa: E501
    ...
    def udp_first_packet(self):
        ...
        The timeout value of connection in seconds after the first packet. This will be the initial timeout for the new UDP flow.  # noqa: E501
    ...
    def icmp_first_packet(self):
        ...
        The timeout value of connection in seconds after the first packet. This will be the initial timeout for the new ICMP flow.  # noqa: E501
