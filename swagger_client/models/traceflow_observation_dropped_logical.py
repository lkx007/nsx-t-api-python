...
class TraceflowObservationDroppedLogical(object):
    ...
    def __init__(self, nat_rule_id=None, reason=None, lport_id=None, lport_name=None, acl_rule_id=None, arp_fail_reason=None, component_id=None, *args, **kwargs):  # noqa: E501
    ...
    def nat_rule_id(self):
        """Gets the nat_rule_id of this TraceflowObservationDroppedLogical.  # noqa: E501

        The ID of the NAT rule that was applied to forward the traceflow packet  # noqa: E501

        :return: The nat_rule_id of this TraceflowObservationDroppedLogical.  # noqa: E501
        :rtype: int
        """
    ...
    def nat_rule_id(self, nat_rule_id):
        """Sets the nat_rule_id of this TraceflowObservationDroppedLogical.

        The ID of the NAT rule that was applied to forward the traceflow packet  # noqa: E501

        :param nat_rule_id: The nat_rule_id of this TraceflowObservationDroppedLogical.  # noqa: E501
        :type: int
        """
    ...
    def arp_fail_reason(self):
        """Gets the arp_fail_reason of this TraceflowObservationDroppedLogical.  # noqa: E501
        ...
        :return: The arp_fail_reason of this TraceflowObservationDroppedLogical.  # noqa: E501
        :rtype: str
        """
    ...
    def arp_fail_reason(self, arp_fail_reason):
        """Sets the arp_fail_reason of this TraceflowObservationDroppedLogical.

        This field specifies the ARP fails reason ARP_TIMEOUT - ARP failure due to query control plane timeout ARP_CPFAIL - ARP failure due post ARP query message to control plane failure ARP_FROMCP - ARP failure due to deleting ARP entry from control plane ARP_PORTDESTROY - ARP failure due to port destruction ARP_TABLEDESTROY - ARP failure due to ARP table destruction ARP_NETDESTROY - ARP failure due to overlay network destruction  # noqa: E501

        :param arp_fail_reason: The arp_fail_reason of this TraceflowObservationDroppedLogical.  # noqa: E501
        :type: str
        """
