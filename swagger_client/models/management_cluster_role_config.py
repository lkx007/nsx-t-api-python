...
class ManagementClusterRoleConfig(object):
    ...
    def __init__(self, type=None, mgmt_cluster_listen_addr=None, mpa_msg_client_info=None, api_listen_addr=None, appliance_connection_info=None, mgmt_plane_listen_addr=None, *args, **kwargs):  # noqa: E501
