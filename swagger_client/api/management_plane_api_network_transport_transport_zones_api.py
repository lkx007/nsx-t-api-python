...
class ManagementPlaneApiNetworkTransportTransportZonesApi(object):
    ...
    def list_transport_zones_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['cursor', 'included_fields', 'is_default', 'page_size', 'sort_ascending', 'sort_by', 'transport_type', 'uplink_teaming_policy_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
