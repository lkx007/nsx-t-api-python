...
class Traceflow(object):
    ...
    def __init__(self, _self=None, links=None, schema=None, operation_state=None, logical_counters=None, timeout=None, result_overflowed=None, lport_id=None, counters=None, request_status=None, analysis=None, id=None, *args, **kwargs):  # noqa: E501
