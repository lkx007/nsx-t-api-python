...
class TransportNodeState(object):
    ...
    def __init__(self, state=None, details=None, failure_code=None, failure_message=None, deployment_progress_state=None, node_deployment_state=None, host_switch_states=None, maintenance_mode_state=None, transport_node_id=None, *args, **kwargs):  # noqa: E501
