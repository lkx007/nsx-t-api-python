...
class ServiceDeploymentSpec(object):
    ...
    def svm_version(self):
        ...
        Partner needs to specify the Service VM version which will get deployed. Modification of this field would notify administrators that new upgrade is available.  # noqa: E501
