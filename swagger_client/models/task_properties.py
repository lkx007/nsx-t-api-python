...
class TaskProperties(object):
    ...
    def __init__(self, _self=None, links=None, schema=None, status=None, async_response_available=None, description=None, start_time=None, cancelable=None, request_method=None, user=None, progress=None, message=None, request_uri=None, id=None, end_time=None, *args, **kwargs):  # noqa: E501
