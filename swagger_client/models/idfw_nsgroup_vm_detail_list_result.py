...
class IdfwNsgroupVmDetailListResult(object):
    ...
    def __init__(self, cursor=None, sort_ascending=None, sort_by=None, result_count=None, ns_group_id=None, results=None, *args, **kwargs):  # noqa: E501
    ...
    @property
    def cursor(self):
        """Gets the cursor of this IdfwNsgroupVmDetailListResult.  # noqa: E501

        Opaque cursor to be used for getting next page of records (supplied by current result page)  # noqa: E501

        :return: The cursor of this IdfwNsgroupVmDetailListResult.  # noqa: E501
        :rtype: str
        """
        return self._cursor
    ...
    def cursor(self, cursor):
        """Sets the cursor of this IdfwNsgroupVmDetailListResult.

        Opaque cursor to be used for getting next page of records (supplied by current result page)  # noqa: E501

        :param cursor: The cursor of this IdfwNsgroupVmDetailListResult.  # noqa: E501
        :type: str
        """
    ...
    def sort_ascending(self):
        """Gets the sort_ascending of this IdfwNsgroupVmDetailListResult.  # noqa: E501

        If true, results are sorted in ascending order  # noqa: E501

        :return: The sort_ascending of this IdfwNsgroupVmDetailListResult.  # noqa: E501
        :rtype: bool
        """
    ...
    def sort_ascending(self, sort_ascending):
        """Sets the sort_ascending of this IdfwNsgroupVmDetailListResult.

        If true, results are sorted in ascending order  # noqa: E501

        :param sort_ascending: The sort_ascending of this IdfwNsgroupVmDetailListResult.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def sort_by(self):
        """Gets the sort_by of this IdfwNsgroupVmDetailListResult.  # noqa: E501

        Field by which records are sorted  # noqa: E501

        :return: The sort_by of this IdfwNsgroupVmDetailListResult.  # noqa: E501
        :rtype: str
        """
    ...
    def sort_by(self, sort_by):
        """Sets the sort_by of this IdfwNsgroupVmDetailListResult.

        Field by which records are sorted  # noqa: E501

        :param sort_by: The sort_by of this IdfwNsgroupVmDetailListResult.  # noqa: E501
        :type: str
        """
    ...
    def result_count(self):
        """Gets the result_count of this IdfwNsgroupVmDetailListResult.  # noqa: E501

        Count of results found (across all pages), set only on first page  # noqa: E501

        :return: The result_count of this IdfwNsgroupVmDetailListResult.  # noqa: E501
        :rtype: int
        """
    ...
    def result_count(self, result_count):
        """Sets the result_count of this IdfwNsgroupVmDetailListResult.

        Count of results found (across all pages), set only on first page  # noqa: E501

        :param result_count: The result_count of this IdfwNsgroupVmDetailListResult.  # noqa: E501
        :type: int
        """
