...
class LbVariablePersistenceLearnAction(object):
    ...
    @property
    def type(self):
        """Gets the type of this LbVariablePersistenceLearnAction.  # noqa: E501

        The property identifies the load balancer rule action type.   # noqa: E501

        :return: The type of this LbVariablePersistenceLearnAction.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this LbVariablePersistenceLearnAction.

        The property identifies the load balancer rule action type.   # noqa: E501

        :param type: The type of this LbVariablePersistenceLearnAction.  # noqa: E501
        :type: str
        """
        if type is None:
