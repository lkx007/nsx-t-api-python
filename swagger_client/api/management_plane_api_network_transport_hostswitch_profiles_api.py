...
class ManagementPlaneApiNetworkTransportHostswitchProfilesApi(object):
    ...
    def list_host_switch_profiles_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['cursor', 'hostswitch_profile_type', 'include_system_owned', 'included_fields', 'page_size', 'sort_ascending', 'sort_by', 'uplink_teaming_policy_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
