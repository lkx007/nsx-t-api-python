...
class ManagementPlaneApiPoolManagementVniPoolsApi(object):
    ...
    def list_vni_pools(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.list_vni_pools(async_req=True)
        >>> result = thread.get()
    ...
    def list_vni_pools_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_vni_pools_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def read_vni_pool(self, pool_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_vni_pool(pool_id, async_req=True)
        >>> result = thread.get()
    ...
    def read_vni_pool_with_http_info(self, pool_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_vni_pool_with_http_info(pool_id, async_req=True)
        >>> result = thread.get()
    ...
    def update_vni_pool(self, body, pool_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_vni_pool(body, pool_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param VniPool body: (required)
        :param str pool_id: VNI pool ID (required)
        :return: VniPool
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_vni_pool_with_http_info(body, pool_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_vni_pool_with_http_info(body, pool_id, **kwargs)  # noqa: E501
            return data

    def update_vni_pool_with_http_info(self, body, pool_id, **kwargs):  # noqa: E501
        """Update a VNI Pool  # noqa: E501

        Updates the specified VNI pool. Modifiable parameters include description, display_name and ranges. Ranges can be added, modified or deleted. Overlapping ranges are not allowed. Only range end can be modified for any existing range. Range shrinking or deletion is not allowed if there are any allocated VNIs.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_vni_pool_with_http_info(body, pool_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_vni_pool`")  # noqa: E501
        # verify the required parameter 'pool_id' is set
        if ('pool_id' not in params or
                params['pool_id'] is None):
