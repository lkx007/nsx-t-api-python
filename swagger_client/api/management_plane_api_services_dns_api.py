...
class ManagementPlaneApiServicesDnsApi(object):
    ...
    def get_dns_forwarder_statistics(self, forwarder_id, **kwargs):  # noqa: E501
        """Get statistics of given dns forwarder  # noqa: E501

        Returns the statistics of the given dns forwarder specified by forwarder id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_dns_forwarder_statistics(forwarder_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_dns_forwarder_statistics_with_http_info(forwarder_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_dns_forwarder_statistics_with_http_info(forwarder_id, **kwargs)  # noqa: E501
            return data

    def get_dns_forwarder_statistics_with_http_info(self, forwarder_id, **kwargs):  # noqa: E501
        """Get statistics of given dns forwarder  # noqa: E501

        Returns the statistics of the given dns forwarder specified by forwarder id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_dns_forwarder_statistics_with_http_info(forwarder_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_dns_forwarder_statistics" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'forwarder_id' is set
        if ('forwarder_id' not in params or
                params['forwarder_id'] is None):
            raise ValueError("Missing the required parameter `forwarder_id` when calling `get_dns_forwarder_statistics`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/dns/forwarders/{forwarder-id}/statistics', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='DnsForwarderStatistics',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
